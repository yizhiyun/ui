	...
	//预警
	function readyChangeHandle(){
		if(save_now_show_view_text.data("show_view_fun") == "many_de_many_me_handle('polyline')" || save_now_show_view_text.data("show_view_fun") == "many_de_many_me_handle('barChart')" || save_now_show_view_text.data("show_view_fun") == "many_de_many_me_handle('number_liner')" || save_now_show_view_text.data("show_view_fun") == "many_de_many_me_handle('comparisonStrip')" || save_now_show_view_text.data("show_view_fun") == "one_de_one_me_handle('area')" || save_now_show_view_text.data("show_view_fun") == "one_de_one_me_handle('scale')" || save_now_show_view_text.data("show_view_fun") == "many_de_many_me_handle('histogram')" || save_now_show_view_text.data("show_view_fun") == "many_de_many_me_handle('number_bar')"){
			if(switch_col_me > 0 || switch_row_me > 0){
				$("#yujing-show").show();
			}
		}else{
			$("#yujing-show").hide();
